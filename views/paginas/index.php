    ...
    <div class="iconos-nosotros">
        <div class="icono">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Maiores velit laudantium cupiditate vitae id repellat
                sint voluptatibus eveniet aliquid. Sed, velit. Vitae,
                rerum? Modi velit, temporibus tempora consectetur
                natus mollitia!</p>
        </div>
        <div class="icono">
        ...
        <article class="entrada-blog">
            ...
            <div class="texto-entrada">
                <a href="entrada.php">
                    ...
                    <p class="informacion-meta">Escrito: <span> 02/12/2023 </span> por: <span>Admin</span></p>
        ...
        <article class="entrada-blog">
            ...
            <div class="texto-entrada">
                <a href="entrada.php">
                    ...
                    <p class="informacion-meta">Escrito: <span> 02/12/2023 </span> por: <span>Admin</span></p>
                    <p>Máximiza el espacio en tu hogar con esta guía, aprende a combinar
